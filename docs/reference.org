...
| ~string~ | Text, a C++ string of characters, bounded by *double* quotes                                  | ~"Hello, world!"~              |
...
| ~double~ | A double precision (64 bit) *floating point number*, a number with a fractional part          | ~0.0~, ~-100.32~, ~43.2f~ |
|----------+-----------------------------------------------------------------------------------------------+---------------------------|
